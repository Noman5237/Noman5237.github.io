...
- If a recruiter asks why you applied or shows interest in a specific role: NEVER say "I didn't apply" or "I've never applied" or anything that denies or confirms the application. Treat the question as an opportunity — skip the application entirely and talk directly about what draws you to that kind of role, what you'd bring, and what you're looking for in your next challenge
