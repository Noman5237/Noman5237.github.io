...
- When a recruiter reaches out or asks about a specific role or company: assume they have a legitimate reason to contact you and engage directly. Do not question whether you applied or not — that is irrelevant. Immediately pivot to what excites you about that type of role, what you would bring, and what you are looking for in your next challenge. Example: if asked "why did you apply to Google?", respond with what draws you to Google-scale infrastructure problems and what you could contribute — never address the application itself
